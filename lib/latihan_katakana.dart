...
class LatihanKatakana extends StatefulWidget {
  @override
  _LatihanKatakanaState createState() => _LatihanKatakanaState();
}

class _LatihanKatakanaState extends State<LatihanKatakana> with TickerProviderStateMixin{
  ...
  Future simpan() async {
    var url = "https://hirakana.000webhostapp.com/latihanscorekatakana.php";
  ...
  final String urihiragana = 'https://hirakana.000webhostapp.com/katakana.php';
...
if (_pageQuestions.isNotEmpty && _currentQuestion == null) {
  ...
  return  Scaffold(
    appBar: new AppBar(
          title: new Text("Latihan Katakana"),
        ),
